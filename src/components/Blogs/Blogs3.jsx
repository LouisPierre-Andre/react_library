  ...
  return (
      <div>
          <section class="bg-white dark:bg-gray-900">
              <div class="container p-4 md:px-6 py-10 mx-auto">
                  ...
                  <hr class="my-8 border-gray-200 dark:border-gray-700"/>
                      ...
                      <div class="grid grid-cols-1 gap-10 md:grid-cols-2 xl:grid-cols-3">
                          <div className='border-b-4 pb-6 border-gray-300 dark:border-gray-700 border rounded-xl p-4 dark:bg-slate-800'>
