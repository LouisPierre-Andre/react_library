...
const CTA4 = () => {
  return (
    <section className="relative z-10 overflow-hidden bg-indigo-600 dark:bg-gray-900 py-16 px-8 my-20">
      <div className="container md:w-[80%] m-auto">
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="w-full px-4 lg:w-1/2">
            <div className="text-center lg:text-left">
              <div className="mb-10 lg:mb-0">
                <h1 className="mt-0 mb-3 text-3xl font-bold leading-tight sm:text-4xl sm:leading-tight md:text-[40px] md:leading-tight text-white dark:text-gray-100">
                  Start building automated serverless forms
                </h1>
                <p className="w-full text-base font-medium leading-relaxed sm:text-lg sm:leading-relaxed text-white dark:text-gray-300">
          ...
          <div className="w-full px-4 lg:w-1/2">
            <div className="text-center lg:text-right">
              <a
                className="font-semibold rounded-lg mx-auto inline-flex items-center justify-center bg-white py-4 px-9 hover:bg-opacity-90 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700"
                href="#"
              >
      ...
      <span className="absolute top-0 right-0 bottom-0  -z-10">
        <svg
          ...
          viewBox="0 0 388 220" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            opacity="0.05"
