...
const CTA6 = () => {
    return (
        <div className='dark:bg-gray-900 py-20 bg-white'>
              

        <section className="w-full max-w-5xl mx-auto md:px-10 lg:px20 overflow-hidden ">
            <div className="bg-gray-800 p-6 md:p-10 md:rounded-2xl mx-auto flex flex-col gap-y-5 justify-center items-center relative">
                <svg
                ...
                <div className="input-form max-w-2xl mx-auto w-full flex flex-col md:flex-row gap-y-2 items-center justify-center lg:justify-start gap-x-5 lg:gap-x-5 mt-5">
                    ...
                    <button
                        className="bg-white w-full md:w-1/3 hover:shadow-md focus:ring-2 focus:ring-indigo-500/50 ring-offset-2 ring-offset-[#EAE8FF] hover:drop-shadow transition duration-200 lg:w-1/3 text-zinc-800 text-sm rounded-lg px-5 py-2.5 shadow-md group font-clash font-[500]"
                    >
                        Send an Email
                        <svg
                            stroke="currentColor"
