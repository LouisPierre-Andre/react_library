...
export default function Statistic1() {
  return (
    <div>
      <section className="flex flex-col mt-20 bg-white dark:bg-gray-900 py-20">
        <p className="font-semibold text-2xl md:text-3xl text-center text-gray-900 dark:text-gray-100">
          Our Outstanding Achievements
        </p>
        <div
          className="mt-10 grid grid-cols-2 lg:grid-cols-4 gap-y-5 lg:gap-y-0 gap-x-5 place-items-center w-full mx-auto max-w-6xl px-5">
          <div
            className="flex flex-col justify-center items-center  bg-[#FFF6F3] dark:bg-gray-800 px-4 h-[126px] w-[100%] md:w-[281px] md:h-[192px] rounded-lg justify-self-center">
