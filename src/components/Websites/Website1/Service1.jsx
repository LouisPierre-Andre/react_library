...
export default function Service1() {
  return (
      <div className='bg-green-50 pt-20'>
          <h1 className='text-3xl font-bold max-w-6xl mx-auto text-center'>Our Services</h1>
          <p class="text-base font-medium text-body-color max-w-xl mx-auto text-gray-700 mt-2 text-center">
              FormBold is free to use, we are offering a decent free
              plan for experiments, personal projects and projects.
          </p>
    ...
    <div class="w-full px-4 md:w-1/2 lg:w-1/3 ">
        <div class="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9 bg-white">
