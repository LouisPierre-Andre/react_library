...
const services = [
    ...
    {
        title: 'Link Multiple Emails',
        description: 'Link multiple email addresses under your parent account, use any of them for your forms to receive submissions.',
        icon: 'Icon', // Remplacez par les icônes SVG ou autres
    },
    {
        title: 'Easy to Use Form API',
        description: 'Simple and easy-to-use form API. All you need to do is paste your endpoint URL on your form, rest assured by FormBold.',
        icon: 'Icon', // Remplacez par les icônes SVG ou autres
    },
    {
        title: 'Connect Apps',
        description: 'Connect apps and integrations with your form, get notified with submitter data when you receive new submissions.',
        icon: 'Icon', // Remplacez par les icônes SVG ou autres
    },
    {
        title: 'Spam Free & Encrypted',
        description: 'We use server-side mechanisms to make sure submissions are spam-free and all messages are end-to-end encrypted.',
        icon: 'Icon', // Remplacez par les icônes SVG ou autres
    },
    {
        title: 'Attach Large Files',
        description: 'You can allow end-users to attach or upload files, and you will receive a CDN link with submission data.',
        icon: 'Icon', // Remplacez par les icônes SVG ou autres
    },
];
...
export default function Service3() {
    return (
        <div className="bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-200">
            <div className="max-w-7xl mx-auto flex flex-wrap md:p-8">
                {services.map((service, index) => (
                    <div key={index} className="w-full px-4 md:w-1/2 lg:w-1/3">
                        <div className="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9 bg-white dark:bg-gray-800">
...
//   return (
//       <div className=''>
//           <div class="max-w-7xl mx-auto flex flex-wrap md:p-8">
