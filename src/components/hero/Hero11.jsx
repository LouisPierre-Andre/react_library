...
// import './App.css'; // Assurez-vous d'importer votre fichier CSS si nécessaire

const Hero11 = () => {
  return (
    <main className="pt-0 min-h-screen">
      {/* Hero Section */}
      <section className=" min-h-screen relative bg-gradient-to-br from-blue-900 to-indigo-800 text-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-24 md:py-32 relative z-10 m-12">
