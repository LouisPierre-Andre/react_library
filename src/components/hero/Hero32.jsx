                  ...
                  <div class="px-6 mx-auto sm:px-8 lg:px-12 max-w-7xl">
                      <div class="w-full lg:w-2/3 xl:w-1/2">
                          ...
                          <p class="mt-6 tracking-tighter text-white">
                              <span class="font-sans font-normal text-5xl xs:text-7xl">The road to the</span><br />
                              <span class="font-serif italic font-normal text-5xl xs:text-8xl">perfect loaf</span>
                          </p>
