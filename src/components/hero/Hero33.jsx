...
export default function Hero33() {
  return (
      <div>
          <div class="relative pt-48 pb-12 bg-black xl:pt-60 sm:pb-16 lg:pb-32 xl:pb-48 2xl:pb-56 min-h-screen">
                  ...
                  <div class="px-6 mx-auto sm:px-8 lg:px-12 max-w-7xl">
                      <div class="max-w-xl mx-auto text-center">
                          <h1 class="tracking-tighter text-white">
                              <span class="font-sans font-normal text-5xl xs:text-7xl">Master</span><br />
                              <span class="font-serif italic font-normal text-5xl xs:text-8xl">Bread making</span>
                          </h1>
